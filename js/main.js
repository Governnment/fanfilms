!(function (t) {
  ...
  if (
    ...
    t('.instafeed-wrapper').each(function () {
      var e =
          'IGQVJXU0UyWVBKSE12ODY5bWROVnE5OTdTbDBrZAHlNbzQxVVZAXNkU5eG9zQ0h4bTRvd2pPSGdPNmNtSWlxLVJoYlRFLUJtX0o3eGFqQjR3WFV4Ulg5OGpiemY2Y3l1RC1sSlNkQkJJbU5pQ1JWT2FMaAZDZD',
        a = t(this),
  ...
  t(document).on('click', '.search-form-icon', function (e) {
    ...
    t(document).on('click', '.close-menu, .close-menu-link', function () {
      O ||
        ((O = !0),
        setTimeout(function () {
          O = !1
    ...
    t(document).on('touchstart click', '.show-menu', function (e) {
      t(e.target).hasClass('push-button') ||
        ...
        t('.close-menu, .close-menu-link').trigger('click')
    }),
  ...
  if (
    ...
    'modern' == _ &&
      t('<div class="navbar-show-modern-bg"></div>').insertAfter('.page-layout')
  }
